...
def run_board_watcher_placer(placers):
    ...
    while True:
        ...
        if float(newest_time) - float(oldest_time) > 60 and len(mismatched_pixels) > total_pixel_count * SLEEP_MISMATCH_THRESHOLD:
        ...
        elif len(mismatched_pixels) < total_pixel_count * SLEEP_MISMATCH_THRESHOLD:
